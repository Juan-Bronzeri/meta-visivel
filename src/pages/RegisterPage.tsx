...
const RegisterPage: React.FC = () => {
    ...
    const onFinish = async (values: RegisterFormValues) => {
        ...
        try {
            ...
            message.success('Registro bem sucedido! Você pode fazer login agora.');
    ...
    return (
        <Row justify="center" align="middle" style={{ minHeight: '100vh', background: '#fdfcff' }}>
            <Col xs={22} sm={16} md={12} lg={8} xl={6}>
                <Card style={{ borderRadius: '8px' }}>
                    <Title level={2} style={{ textAlign: 'center', marginBottom: '24px' }}>Registrar</Title>
                    <Form
                        name="register_form"
                        onFinish={onFinish}
                        size="large"
